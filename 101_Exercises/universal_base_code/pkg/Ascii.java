...
public class Ascii {
	...
	private String checkType(String a){					// Checks if the input String a is valid
		...
		else if(a.equals("stringOne") || a.equals("Charizard")){
			return "stringOne";
		}
		else if(a.equals("stringTwo") || a.equals("Blastoise")){
			return "stringTwo";
		}
		else if(a.equals("stringThree") || a.equals("venusaur")){
			return "stringThree";
		}
		else{
			return "Human";
	...
	public void printArt(){				// Prints out the name and the art number times
		...
		while (i < number){
			...
			else if(type.equals("stringThree")){
				System.out.println("   _____");
				System.out.println("  /|   /|");
